    ...
    const jokerActors: {}[] = [
      {
        firstname: 'Joaquin',
        lastname: 'Phoenix',
        photo: 'https://m.media-amazon.com/images/M/MV5BZGMyY2Q4NTEtMWVkZS00NzcwLTkzNmQtYzBlMWZhZGNhMDhkXkEyXkFqcGdeQXVyNjk1MjYyNTA@._V1_.jpg',
    ...
    const hapinessActors: {}[] = [
      {
        firstname: 'Will',
        lastname: 'Smith',
        photo: 'https://m.media-amazon.com/images/M/MV5BNTczMzk1MjU1MV5BMl5BanBnXkFtZTcwNDk2MzAyMg@@._V1_UY317_CR2,0,214,317_AL_.jpg',
        imdbUrl: 'https://www.imdb.com/name/nm0000226/'
      },
      {
        firstname: 'Jade',
        lastname: 'Smith',
        photo: 'https://m.media-amazon.com/images/M/MV5BMjMwMjU2MTQ4MF5BMl5BanBnXkFtZTgwODM5OTMzODE@._V1_UX214_CR0,0,214,317_AL_.jpg4e',
